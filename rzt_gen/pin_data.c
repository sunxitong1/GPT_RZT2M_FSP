...
{ .pin = BSP_IO_PORT_00_PIN_0, .pin_cfg =
  ...
  { .pin = BSP_IO_PORT_17_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P175_PFC_03_GTIOC0B) },
